...
import sys
import os
from .twitter_user_scraper_node import LokiUserScraper # Import the new node class
...
# --- Node Registration --- 
NODE_CLASS_MAPPINGS = {
    "LokiUserScraper": LokiUserScraper
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "LokiUserScraper": "🐦👤 Scrape User Profile (LOKI)"
}
